        ...
        {inventories.length > 1 && (
          <Field label="Inventario">
            <select
              ...
              className="h-10 w-full rounded-lg border border-input bg-background px-3 text-base sm:text-sm outline-hidden focus-visible:ring-2 focus-visible:ring-ring/40"
            >
              {inventories.map((i) => (

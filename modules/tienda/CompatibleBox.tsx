...
export function CompatibleBox({
  ...
  return (
    <section className="mx-auto mt-8 max-w-5xl overflow-hidden rounded-2xl border border-tienda-200 dark:border-tienda-900 bg-linear-to-br from-tienda-50 to-tienda-50/60 text-left">

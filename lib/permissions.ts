...
export const CATALOGO_PERMISOS: {
  ...
  },
  {
    ...
    permisos: [
      ...
      { key: "caja_movimientos", label: "Registrar gastos e ingresos", desc: "Capturar gastos e ingresos extra de caja, sin ver el corte ni los reportes." },
      { key: "caja_cuadre", label: "Cuadrar la caja", desc: "Cuadre del día: ver cuánto debería haber, contar, cerrar el día y revisar diferencias. Sin ver el corte ni los reportes." },

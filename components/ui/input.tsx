...
>(({ className, autoFocus, ...props }, ref) => {
  ...
  return (
    <input
      ...
      className={cn(
        "h-10 w-full rounded-lg border border-border bg-background px-3 text-base sm:text-sm text-foreground transition-colors placeholder:text-muted-foreground/70 focus:border-ring focus:outline-hidden focus:ring-2 focus:ring-ring/10 disabled:opacity-50",
        className,
      )}
      {...props}
    />
...
>(({ className, children, ...props }, ref) => (
  <select
    ref={ref}
    className={cn(
      "h-10 w-full cursor-pointer rounded-lg border border-border bg-background px-3 text-base sm:text-sm text-foreground transition-colors focus:border-ring focus:outline-hidden focus:ring-2 focus:ring-ring/10 disabled:opacity-50",
      className,
    )}
    {...props}
  >
